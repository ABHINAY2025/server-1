...
import com.example.paymentProcess.utility.paymentFileUtility.AutoCorrectUtility;
import com.example.paymentProcess.utility.paymentFileUtility.BicValidationUtility;
import com.example.paymentProcess.utility.paymentFileUtility.StpConfigurationUtility;
...
public class PaymentProcessUtility {
    ...
    private String createUpdatedXml(Document document, Payments.Debtor debtor, Payments.Creditor creditor) throws Exception {
        ...
        // Preserve the structure of the IBAN (wrapped in <ns0:Othr> for debtor)
        ...
        // Preserve the structure of the IBAN (wrapped in <ns0:Othr> for creditor)
    ...
    private void updateIbanElement(Document document, String parentTagName, String ibanValue) {
        ...
        if (accountNodes.getLength() > 0) {
            ...
            // Check if <ns0:Othr> exists inside <ns0:Id>
            NodeList othrNodes = idElement.getElementsByTagName("ns0:Othr");
            Element othrElement;
            if (othrNodes.getLength() == 0) {
                // Create <ns0:Othr> inside <ns0:Id> if it doesn't exist
            ...
            // Create <ns0:Id> inside <ns0:Othr> and set the IBAN value
